...
{
    /// <summary>
    /// The preceding code is a command for creating new TourList, and we are using the 
    /// MediatR package here:
    /// </summary>
    ...
    public class CreateTourListCommandHandler : IRequestHandler<CreateTourListCommand, int>
    {
        ...
        {
            //var entity = new TourList { City = request.City, Country = request.Country, About = request.About }; -- IN CASE SWAGGER POST DON'T WORK
