...
{
    /// <summary>
    /// The following code logs the responses' elapsed time in milliseconds of PipelineBehavior.PipelineBehavior
    /// wraps the inner handler and adds an implementation for additional behavior in the request.
    /// </summary>
